    ...
    return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return ListTile(
              ...
              title: Text(profiles[index].name, style: const TextStyle(color: Colors.black),),
              subtitle: Text(profiles[index].phoneNumber, style: const TextStyle(color: Colors.black),),
            );
          },
        );
  }
